...
<head>
  ...
  <meta name="description" content="Crea insieme a me la tua pagina web ideale"/>

  <!-- Facebook Open Graph-->
  <meta property="og:url" content="https://lizzit.github.io/WebDevelopment/" /> 
  <meta property="og:title" content="WebDevelopment | Crea la tua pagina web con me" /> 
  <meta property="og:image" content="https://lizzit.github.io/WebDevelopment/images/Webdevelopment.png" /> 
  <meta property="og:description" content="Crea insieme a me la tua pagina web ideale" />
 ...
 <link rel="stylesheet" href="font-awesome/css/font-awesome.min.css">
  ...
  <script async>
    (function(s,u,m,o,j,v){
      ...
      j.async=1;
      j.src=o;
      j.dataset.sumoSiteId='53b6fed9a24e78b7872b9b9de4aff209dce2d70444a8af64a39dee7da374c386';
...
.showMenu {
  ...
  <div id="index-banner" class="parallax-container">
    <div class="section-intro no-pad-bot">
      <div class="container">
        ...
        <div class="row center">
          <a href="#servizio" class="btn-large waves-effect waves-light grey">Cominciamo!</a>
        </div>
        <br><br>
      </div>
    </div>
        ...
        <div class="row">
          <div class="">
            <div class="icon-block">
              ...
              <h5 class="center">Creo la tua pagina esattamente come tu vuoi</h5>
              <p class="light">Insieme a te creerò la tua pagina internet in modo che tutto corrisponda ai tuoi gusti e alle tue necessità. Per farlo utilizzeremo Skype in videochiamata in modo che tu possa vedere le modifiche in tempo reale prima che la pagina venga caricata sul web!</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <!-- Registrazione -->
  <div id="Registrazione" class="parallax-container vallagin-wrapper">
    <div class="section-registrazione no-pad-bot">
      <div class="container">
        <div class="row center">
          <h3 class="col s12 light">Sei in cerca della tua webpage ideale?</h3>
          <h5 class="col s12 registrazione-subtitle">Registrati per richiedere la nuova webpage</h5>
          <div class="row">
            <div class="input-field col s12 l6 offset-l3">

              <!-- Begin Mailchimp Signup Form -->
              <div id="mc_embed_signup">
                <form action="https://facebook.us19.list-manage.com/subscribe/post?u=309b04be8ba414bcdf0d008bf&amp;id=2c692d6f5c" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                  <div id="mc_embed_signup_scroll">
                    ...
                    <button class="btn btn-registrazione waves-effect waves-light blue" type="submit" name="action">Iscriviti</button>-->
                    <a class="typeform-share button" href="https://elia72.typeform.com/to/XiIVWG" data-mode="drawer_left" style="display:inline-block;text-decoration:none;background-color:#267DDD;color:white;cursor:pointer;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:50px;text-align:center;margin:0;height:50px;padding:0px 33px;border-radius:25px;max-width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;font-weight:bold;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;" target="_blank">Iscriviti</a>
                  </div>
                <form>
              </div>
  ...
  <footer class="page-footer teal">
    <div class="container">
      <div class="row">
        <div id="Contatti" class="contatti col l12 s12 center">
          ...
          <a href="https://www.facebook.com/WebDevelopms" target="_blank" class="social-icon">
    ...
    <div class="footer-copyright">
      <div class="container">
        Made by <a class="brown-text text-lighten-3" href="http://materializecss.com">WebDevelopment &copy</a>
      </div>
    </div>
  </footer>
  ...
  <!-- Google Analitycs-->
  <script async src="https://www.googletagmanager.com/gtag/js?id=UA-130663970-1"></script>
  <script>
